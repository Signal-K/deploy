...
/** @type {string} */
const CACHE_VERSION = '1753659164|68936051';
/** @type {string} */
const CACHE_PREFIX = 'Client-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'web.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["web.html","web.js","web.offline.html","web.icon.png","web.apple-touch-icon.png","web.audio.worklet.js","web.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["web.wasm","web.pck"];
